    ...
    return function (e) {
        ...
        function a(e, t) {
            return function (t) {
                ...
                return s(o, t), o.prototype.getOptions = function () {
                }, o.prototype.getFilters = function () {
                }, o.prototype.isEmptyAfterSelection = function () {
                    return !!this.element.attr("multiple")
                }, o.prototype.onChange = function () {
                    var t = this.uploader.isHTML5 ? this.element[0].files : this.element[0], o = this.getOptions(), n = this.getFilters();
        ...
        function r(e, t, o) {
            return {
                link: function (n, r, i) {
                    ...
                    var a = new o({uploader: s, element: r, scope: n});
